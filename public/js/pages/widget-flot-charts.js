...
$(function () {
    ...
    var interactive_plot = $.plot('#interactive', [getRandomData()], {
	  ...
	  tooltip: true,
      lines : {
        fill : '#00BCD4', //Converts the line chart to area chart
        color: '#00BCD4'
      },
	  tooltipOpts: {
            content: "Visit: %y"
	...
	if( $('#line_chart_moving').length > 0 ){	
		...
		/*Chart Plot*/
		$.plot($("#line_chart_moving"), [fill_line_chart_data], fill_line_chartop);
    ...
    var donutData = [
      { label: 'Jan-Apr', data: 85, color: '#FF4961' },
      { label: 'May-Aug', data: 68, color: '#1E9FF2' },
      { label: 'Sep-Dec', data: 42, color: '#FF9149' }
    ]

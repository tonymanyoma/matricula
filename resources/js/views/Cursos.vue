				...
				<div class="row">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group">
                            ...
                            <input id="intensidad" type="number" class="form-control" v-model="newintensidad_horaria" min="1" required pattern="[0-9]+" title="Ingrese sólo Números">
                          </div>
                          <!-- /.input group -->
                          </div>
        ...
        <!-- Modal -->
            ...
            <div class="col s12" >
                          ...
                          <div class="input-group">
                            ...
                            <input id="edit-nombre" type="text" class="form-control" v-model="fillcursos.nombre" required  title="Ingrese sólo Letras">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="input-group">
                            ...
                            <input id="edit-intensidad" type="number" class="form-control" v-model="fillcursos.intensidad_horaria" min="1" required pattern="[0-9]+" title="Ingrese sólo Números">
                          </div>
                          <!-- /.input group -->
                          </div>
